...
$(document).ready(function() {
	...
	// ======= Showing teams ==========
	$('html').bind('click touch', '#teams_button', function(){
		$('#teams').slideToggle()
		$('html, body').animate({
	...
	// ======= Showing matches ==========
	$('html').bind('click touch', '#matches_button', function(){
		$('#matches').slideToggle()
	...
	$('html').bind('click tap', 'div.match', function(e){
		$(this).slideToggle()
	...
	$('html').bind('click tap', '.score_result', function(e){
	...
	$('html').bind('click tap', '.scores', function(e){
	...
	$('html').bind('click tap', '.game', function(e){
