...
$(document).ready(function() {
	...
	// ======= Showing teams ==========
	$('#teams_button').on('click touch', function(){
		$('#teams').slideToggle()
		$('html, body').animate({
	...
	// ======= Showing matches ==========
	$('#matches_button').on('click touch', function(){
		$('#matches').slideToggle()
	...
	$('div.match').on('click tap', function(e){
		$(this).slideToggle()
	...
	$('.score_result').on('click tap', function(e){
	...
	$('.scores').on('click tap', function(e){
