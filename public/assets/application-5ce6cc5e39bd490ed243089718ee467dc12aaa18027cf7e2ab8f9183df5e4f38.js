...
$(document).ready(function() {
	...
	function addForm(e){
		...
		$.ajax({
	      ...
	      scrollTop: $(".create_form").offset().top
			...
			document.getElementById("create").removeEventListener("click touchstart", addForm);
			document.getElementById("create").addEventListener("click touchstart", formSlide);
		})
	}
	// -------------------------------
	...
	// ======= Showing players ==========
	$('body').on('click touchstart', '#players_button', function(e){
		e.preventDefault()
		alert('work')
		$('#players').slideToggle()
		$('html, body').animate({
	...
	// ======= Showing teams ==========
	$('html').on('click touchstart', '#teams_button', function(){
		$('#teams').slideToggle()
		$('html, body').animate({
	...
	// ======= Showing matches ==========
	$('html').on('click touchstart', '#matches_button', function(){
		$('#matches').slideToggle()
	...
	$('html').on('click touchstart', '.match', function(e){
		$(this).slideToggle()
	...
	$('html').on('click touchstart', '.score_result', function(e){
	...
	$('html').on('click touchstart', '.scores', function(e){
	...
	$('html').on('click touchstart', '.game', function(e){
